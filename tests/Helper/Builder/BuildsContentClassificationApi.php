...
trait BuildsContentClassificationApi
{
    protected function buildApi(MockHttpClient $http): ContentClassificationApi
    {
        $factory = new Psr17Factory();
        $apiClient = new ApiClient($http, $factory, $factory, 'client-id');
        $serializer = SymfonyDenormalizerFactory::create();

        return new ContentClassificationApi($apiClient, $serializer, $serializer);
    }
}
