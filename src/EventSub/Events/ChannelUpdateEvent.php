...
#[EventSubSubscription(type: 'channel.update', version: '2', condition: ChannelUpdateCondition::class)]
final readonly class ChannelUpdateEvent implements EventInterface
{
    /**
