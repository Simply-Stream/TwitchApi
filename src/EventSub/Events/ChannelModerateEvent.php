...
use SimplyStream\TwitchApi\EventSub\Events\Moderate\Warn;

#[EventSubSubscription(type: 'channel.moderate', version: '2', condition: ChannelModerateCondition::class)]
final readonly class ChannelModerateEvent implements EventInterface
{
    /**
     ...
     * @param string            $action                     The action performed. See the Twitch docs for the full
     ...
     * @param Warn|null         $warn                       Optional. Metadata for the warn command.
