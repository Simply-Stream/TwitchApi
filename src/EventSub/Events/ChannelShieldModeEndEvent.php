...
use SimplyStream\TwitchApi\EventSub\Conditions\ChannelShieldModeEndCondition;
use SimplyStream\TwitchApi\EventSub\EventInterface;

#[EventSubSubscription(type: 'channel.shield_mode.end', version: '1', condition: ChannelShieldModeEndCondition::class)]
final readonly class ChannelShieldModeEndEvent implements EventInterface
{
    /**
     ...
     * @param DateTimeInterface $endedAt              The UTC timestamp (RFC3339) of when the moderator deactivated
     *                                                Shield Mode.
     */
