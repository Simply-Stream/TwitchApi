...
final class GetExtensionAnalyticsRequest
{
    /**
     ...
     *
     *                                            The start date must be on or after January 31, 2018. If you specify
     *                                            an earlier date, the API ignores it and uses January 31, 2018. If you
     *                                            specify a start date, you must specify an end date. If you don’t
     *                                            specify a start and end date, the report includes all available data
     ...
     *                                            The minimum page size is 1 URL per page and the maximum is 100 URLs
