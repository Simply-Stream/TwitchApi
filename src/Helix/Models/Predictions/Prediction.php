...
final readonly class Prediction
{
     ...
     * @param DateTimeImmutable $endedAt            The UTC date and time of when the Prediction ended. If status is
     *                                              ACTIVE, this is set to null.
     * @param DateTimeImmutable $lockedAt           The UTC date and time of when the Prediction was locked. If status
