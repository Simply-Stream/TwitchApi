...
final readonly class GuestStarInvite
{
     ...
     *                                             acknowledged it.
     *                                             - ACCEPTED: The invited user has acknowledged the invite and joined
     *                                             the waiting room, but may still be setting up their media devices or
     *                                             otherwise preparing to join the call.
     ...
     * @param bool              $isVideoAvailable  Flag signaling that the invited user has a video device available
     *                                             for sharing.
     * @param bool              $isAudioAvailable  Flag signaling that the invited user has an audio device available
     *                                             for sharing.
     */
