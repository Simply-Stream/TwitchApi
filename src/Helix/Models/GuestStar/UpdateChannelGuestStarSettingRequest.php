...
final readonly class UpdateChannelGuestStarSettingRequest extends AbstractModel
{
     ...
     *                                                 following values:
     *                                                 - TILED_LAYOUT: All live guests are tiled within the browser
     *                                                 source with the same size.
     *                                                 - SCREENSHARE_LAYOUT: All live guests are tiled within the
     *                                                 browser source with the same size. If there is an active screen
     *                                                 share, it is sized larger than the other guests.
     *                                                 - HORIZONTAL_LAYOUT: All live guests are arranged in a
     *                                                 horizontal bar within the browser source
     *                                                 - VERTICAL_LAYOUT: All live guests are arranged in a vertical
