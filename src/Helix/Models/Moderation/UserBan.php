...
final readonly class UserBan
{
     ...
     *                                          placed.
     * @param DateTimeImmutable $endTime        The UTC date and time (in RFC3339 format) that the timeout will end. Is
     *                                          null if the user was banned instead of being put in a timeout.
     */
