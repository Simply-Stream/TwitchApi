...
final readonly class AddBlockedTerm
{
    /**
    ...
    public function __construct(
        ...
        Assert::minLength(
            $this->text,
            2,
            sprintf('The term must contain a minimum of 2 characters, got %s', strlen($this->text)),
        );
        Assert::maxLength(
            $this->text,
            500,
            sprintf('The term must contain a maximum of 500 characters, got %s', strlen($this->text)),
        );
    }
}
