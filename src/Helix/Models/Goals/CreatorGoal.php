...
final readonly class CreatorGoal
{
     ...
     *                                             subscriptions.
     *                                             - new_subscription — The goal is to increase subscriptions. This
     ...
     *                                             - If type is subscription, this field is increased and decreased by
     *                                             the points value associated with the subscription tier. For example,
     *                                             if a tier-two subscription is worth 2 points, this field is
     *                                             increased or decreased by 2, not 1.
     *                                             - If type is subscription_count, this field is increased by 1 for
     *                                             each new subscription and decreased by 1 for each user that
     *                                             unsubscribes.
     *                                             - If type is new_subscription, this field is increased by the points
     *                                             value associated with the subscription tier. For example, if a
     *                                             tier-two subscription is worth 2 points, this field is increased by
     *                                             2, not 1.
     *                                             - If type is new_subscription_count, this field is increased by 1
