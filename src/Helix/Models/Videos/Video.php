...
final readonly class Video
{
     ...
     *                                           replace the
     *                                           %{width}
     *                                           and %{height} placeholders with the width and height of the thumbnail
     *                                           you want returned. Specify the width and height in pixels. Because the
     *                                           CDN preserves the thumbnail’s ratio, the thumbnail may not be the exact
     *                                           size you requested.
     ...
     *                                           For example, the language code is DE if the video was broadcast in
     *                                           German. For a list of supported languages, see Supported Stream
     *                                           Language. The language value is “other” if the video was broadcast in a
    ...
    public function __construct(
        ...
        private ?array $mutedSegments = null
    ) {
    }
