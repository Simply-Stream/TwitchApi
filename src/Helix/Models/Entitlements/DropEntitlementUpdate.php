...
final readonly class DropEntitlementUpdate
{
     ...
     *                             - SUCCESS — The status of the entitlements in the ids field were successfully
     *                             updated.
     *                             - UNAUTHORIZED — The user or organization identified by the user access token is not
     *                             authorized to update the entitlements.
     *                             - UPDATE_FAILED — The update failed. These are considered transient errors and the
     *                             request should be retried later.
     * @param list<string> $ids    The list of entitlements that the status in the status field applies to.
     */
