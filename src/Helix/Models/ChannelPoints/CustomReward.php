...
final readonly class CustomReward
{
     ...
     *                                                                      reward is currently paused. Is true if the
     *                                                                      reward is paused. Viewers can’t redeem
     *                                                                      paused rewards.
     * @param bool                       $isInStock                         A Boolean value that determines whether the
     *                                                                      reward is currently in stock. Is true if
     *                                                                      the reward is in stock. Viewers can’t
     ...
     *                                                                      status immediately when a reward is
