...
final readonly class Extension
{
     ...
     *                                            that use Bits. Is true if the extension has features that use Bits.
     * @param bool     $canInstall                A Boolean value that determines whether a user can install the
     *                                            extension on their channel. Is true if a user can install the
     *                                            extension.
     *
     *                                            Typically, this is set to false if the extension is currently in
     *                                            testing mode and requires users to be allowlisted (the allowlist is
     *                                            configured on Twitch’s developer site under the Extensions ->
     *                                            Extension -> Version -> Access).
     * @param string   $configurationLocation     The location of where the extension’s configuration is stored.
     *                                            Possible values are:
     ...
     * @param bool     $hasChatSupport            A Boolean value that determines whether the extension can communicate
     *                                            with the installed channel’s chat. Is true if the extension can
     *                                            communicate with the channel’s chat room.
     * @param string   $iconUrl                   A URL to the default icon that’s displayed in the Extensions
     *                                            directory.
     * @param string[] $iconUrls                  A dictionary that contains URLs to different sizes of the default
     ...
     * @param bool     $requestIdentityLink       A Boolean value that determines whether the extension wants to
     ...
     *                                            - Rejected
     *                                            - Released
     * @param string   $subscriptionsSupportLevel Indicates whether the extension can view the user’s subscription
     ...
     * @param string   $summary                   A short description of the extension that streamers see when hovering
     *                                            over the discovery splash screen in the Extensions manager.
     ...
     * @param string[] $allowlistedConfigUrls     Allowlisted configuration URLs for displaying the extension (the
     *                                            allowlist is configured on Twitch’s developer site under the
     *                                            Extensions -> Extension -> Version -> Capabilities).
     * @param string[] $allowlistedPanelUrls      Allowlisted panel URLs for displaying the extension (the allowlist is
     *                                            configured on Twitch’s developer site under the Extensions ->
