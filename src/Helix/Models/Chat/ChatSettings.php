...
final readonly class ChatSettings
{
     ...
     *                                              otherwise, false.
     * @param bool   $followerMode                  A Boolean value that determines whether the broadcaster restricts
     *                                              the chat room to followers only.
     *
     *                                              Is true if the broadcaster restricts the chat room to followers
     *                                              only; otherwise, false.
     *
     *                                              See the follower_mode_duration field for how long users must follow
     *                                              the broadcaster before being able to participate in the chat room.
     * @param int    $followerModeDuration          The length of time, in minutes, that users must follow the
     *                                              broadcaster before being able to participate in the chat room. Is
     *                                              null if follower_mode is false.
     * @param string $moderatorId                   The moderator’s ID. The response includes this field only if the
     *                                              request specifies a user access token that includes the
     *                                              moderator:read:chat_settings scope.
     * @param bool   $nonModeratorChatDelay         A Boolean value that determines whether the broadcaster adds a
     ...
     *                                              scope and the user in the moderator_id query parameter is one of
     *                                              the broadcaster’s moderators.
     * @param int    $nonModeratorChatDelayDuration The amount of time, in seconds, that messages are delayed before
     ...
     * @param int    $slowModeWaitTime              The amount of time, in seconds, that users must wait between
     *                                              sending messages.
     *
     *                                              Is null if slow_mode is false.
     * @param bool   $subscriberMode                A Boolean value that determines whether only users that subscribe
