...
final readonly class ChatSettings
{
     ...
     *                                                   follow the broadcaster before being able to participate in the
     *                                                   chat room.
     ...
     *                                                   otherwise, false.
     * @param string|null $moderatorId                   The moderator’s ID. The response includes this field only if
     *                                                   the request specifies a user access token that includes the
     ...
     *                                                   false.
     *
     *                                                   The response includes this field only if the request specifies
     *                                                   a user access token that includes the
     *                                                   moderator:read:chat_settings scope and the user in the
     *                                                   moderator_id query parameter is one of the broadcaster’s
     *                                                   moderators.
     * @param int|null    $nonModeratorChatDelayDuration The amount of time, in seconds, that messages are delayed
     *                                                   before appearing in chat. Is null if non_moderator_chat_delay
     *                                                   is false.
     *
     *                                                   The response includes this field only if the request specifies
     *                                                   a user access token that includes the
