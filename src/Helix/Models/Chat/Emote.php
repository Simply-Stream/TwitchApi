...
readonly class Emote
{
     ...
     *                              templated URL in the template field to fetch the image instead of using these URLs.
     ...
     * @param string[] $scale       The sizes that the emote is available in. For example, if the emote is available in
     *                              small and medium sizes, the array contains 1.0 and 2.0. Possible sizes are:
