...
final readonly class UpdateChatSettingsRequest extends AbstractModel
{
    /**
     ...
     *
     *                                                 Set to true if the broadcaster restricts the chat room to
     *                                                 followers only; otherwise, false. The default is true.
     *
     *                                                 To specify how long users must follow the broadcaster before
     *                                                 being able to participate in the chat room, see the
     ...
     *                                                 viewers can see the message.
     *
     *                                                 Set to true if the broadcaster applies a delay; otherwise,
     ...
     *                                                 messages; otherwise, false. The default is false.
     *
     ...
     *                                                 sending messages. Set only if slow_mode is true.
     *
     *                                                 Possible values are: 3 (3 second delay) through 120 (2 minute
     *                                                 delay). The default is
     *                                                 30 seconds.
     ...
     *
     *                                                 Set to true if the broadcaster restricts the chat room to
     *                                                 subscribers only; otherwise, false. The default is false.
     ...
     *
     *                                                 Set to true if the broadcaster allows only unique messages;
