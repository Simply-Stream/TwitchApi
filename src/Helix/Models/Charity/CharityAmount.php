...
final readonly class CharityAmount
{
     ...
     *                              set to 550.
     * @param int    $decimalPlaces The number of decimal places used by the currency. For example, USD uses two
     *                              decimal places. Use this number to translate value from minor units to major units
     *                              by using the formula: value / 10^decimal_places
