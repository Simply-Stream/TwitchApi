...
final readonly class ProductData
{
     ...
     * @param bool   $inDevelopment A Boolean value that determines whether the product is in development. Is true if
     *                              the digital product is in development and cannot be exchanged.
     ...
     * @param bool   $broadcast     A Boolean value that determines whether the data was broadcast to all instances of
     *                              the extension. Is true if the data was broadcast to all instances.
     */
