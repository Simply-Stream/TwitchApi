...
final readonly class Cheermote
{
     ...
     *                                         cheer 100 Bits, the full Cheermote string is Cheer100. When the
     *                                         Cheermote string is entered in chat, Twitch converts it to the image
     *                                         associated with the Bits tier that was cheered.
     * @param Tier[]            $tiers         A list of tier levels that the Cheermote supports. Each tier identifies
     *                                         the range of Bits that you can cheer at that tier level and an image
     *                                         that graphically identifies the tier level.
     ...
     *                                         Bits card.
     *                                         - global_third_party — A Twitch-defined Cheermote that is not shown in
     *                                         the Bits card.
     ...
     *                                         user cheered Terminator100, the broadcaster might receive 110 Bits,
     *                                         which includes the sponsor's 10 Bits contribution.
     * @param int               $order         The order that the Cheermotes are shown in the Bits card. The numbers
     *                                         may not be consecutive. For example, the numbers may jump from 1 to 7 to
