...
interface EventInterface
{
    public const AVAILABLE_EVENTS = [
        ...
        Subscriptions\GoalBeginSubscription::TYPE => GoalEvent::class,
        Subscriptions\GoalProgressSubscription::TYPE => GoalEvent::class,
        Subscriptions\GoalEndSubscription::TYPE => GoalEvent::class,
