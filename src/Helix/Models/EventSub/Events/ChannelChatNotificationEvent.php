...
final readonly class ChannelChatNotificationEvent extends Event
{
     ...
     *                                                                           - bits_badge_tier
     *                                                                           - charity_donation
     * @param Notifications\Subscription|null              $sub                  Information about the sub event. Null
     *                                                                           if notice_type is not sub.
     * @param Notifications\Resubscription|null            $resub                Information about the resub event.
     *                                                                           Null if notice_type is not resub.
     * @param Notifications\GiftSubscription|null          $subGift              Information about the gift sub event.
     *                                                                           Null if notice_type is not sub_gift.
     * @param Notifications\CommunityGiftSubscription|null $communitySubGift     Information about the community gift
     *                                                                           sub event. Null if notice_type is not
     *                                                                           community_sub_gift.
     * @param Notifications\GiftPaidUpgrade|null           $giftPaidUpgrade      Information about the community gift
     *                                                                           paid upgrade event. Null if
     *                                                                           notice_type is not gift_paid_upgrade.
     * @param Notifications\PrimePaidUpgrade|null          $primePaidUpgrade     Information about the Prime gift paid
     *                                                                           upgrade event. Null if notice_type is
     *                                                                           not prime_paid_upgrade.
     * @param Notifications\Raid|null                      $raid                 Information about the raid event. Null
     *                                                                           if notice_type is not raid.
     * @param array|null                                   $unraid               Returns an empty payload if
     *                                                                           notice_type is unraid, otherwise
     *                                                                           returns null.
     * @param Notifications\PayItForward|null              $payItForward         Information about the pay it forward
     *                                                                           event. Null if notice_type is not
     *                                                                           pay_it_forward.
     * @param Notifications\Announcement|null              $announcement         Information about the announcement
     *                                                                           event. Null if notice_type is not
     *                                                                           announcement
     * @param Notifications\CharityDonation|null           $charityDonation      Information about the charity donation
     *                                                                           event. Null if notice_type is not
     *                                                                           charity_donation.
     * @param Notifications\BitsBadgeTier|null             $bitsBadgeTier        Information about the bits badge tier
     *                                                                           event. Null if notice_type is not
     *                                                                           bits_badge_tier.
     */
