...
final readonly class GoalsEvent extends Event
{
     ...
     *                                                  This type shows only the net increase in tier points associated
     *                                                  with the subscriptions (it does not account for users that
     *                                                  unsubscribed since the goal started).
     *                                                  - new_subscription_count — The goal is to increase
     ...
     *                                                  40
     *                                                  characters.
     * @param bool              $isAchieved             A Boolean value that indicates whether the broadcaster achieved
     *                                                  their goal. Is true if the goal was achieved; otherwise, false.
     ...
     *                                                  - If type is subscription, this field is increased and
     *                                                  decreased by the points value associated with the subscription
     *                                                  tier. For example, if a tier-two subscription is worth 2
     *                                                  points, this field is increased or decreased by 2, not 1.
     *                                                  - If type is subscription_count, this field is increased by 1
     *                                                  for each new subscription and decreased by 1 for each user that
     *                                                  unsubscribes.
     *                                                  - If type is new_subscription, this field is increased by the
     *                                                  points value associated with the subscription tier. For
     *                                                  example, if a tier-two subscription is worth 2 points, this
     *                                                  field is increased by 2, not 1.
     *                                                  - If type is new_subscription_count, this field is increased by
     ...
     *                                                  double that number, this field is set to
     *                                                  400.
     * @param DateTimeImmutable $startedAt              The UTC timestamp in RFC 3339 format, which indicates when the
     *                                                  broadcaster created the goal.
     * @param DateTimeImmutable $endedAt                The UTC timestamp in RFC 3339 format, which indicates when the
     *                                                  broadcaster ended the goal. Only the channel.goal.end event
     *                                                  includes this field.
     */
