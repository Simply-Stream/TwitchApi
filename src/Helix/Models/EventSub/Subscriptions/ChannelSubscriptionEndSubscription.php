...
use SimplyStream\TwitchApi\Helix\Models\EventSub\Condition\ChannelSubscriptionEndCondition;
...
final readonly class ChannelSubscriptionEndSubscription extends Subscription
{
    ...
    public function __construct(
        ...
        parent::__construct(
            $type,
            $version,
            new ChannelSubscriptionEndCondition($condition['broadcasterUserId']),
            $transport,
            $id,
            $status,
            $createdAt
